...
// (Estes dados viriam do 'loader' da rota pai no futuro)
...
// 1. Cria a rota "prontuario"
// Esta rota é /_doctor/patients/$patientId/prontuario
export const Route = createFileRoute('/_doctor/src/pages/_doctor/patients/$patientId/prontuario')({
...
// ---------------------------------------------
// O COMPONENTE DA PÁGINA ("Prontuário")
// ---------------------------------------------
function PatientRecordPage() {
  // Obtém o 'patientId' do URL
  // (O erro de TypeScript aqui é temporário)
  const { patientId } = useParams({ from: '/_doctor/patients/$patientId/prontuario' })
